...
class Demo(PipelineStructure):
    def __init__(self, args):
        ...
        self.testedModes = {'rna': None, 'translation': None, 'database': None, 'search': None, 'postms': None,
                            'ribocov': None}
        self.issues = {}
    ...
    def __test_search_mode(self):
        ...
        if not self.args.skip_postms:
            ...
            skip = True
        file = f'{self.postProcessDir}/group/GSE125218_K562_Cufflinks_transcript_assembly_target_decoy_database.fasta/peptides_filtered.txt'
    ...
    def __test_ribocov_mode(self):
        ...
        self.__check_files(file=f'{self.countsDir}/heatmap.png', tool='Python package nheatmap', skipped=skip,
